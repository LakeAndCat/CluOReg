...
------------      -----------    --------    -----------
2020/10/10 20:33   guzhouweihu      1.0         None
'''
...
class Cub2011(VisionDataset):
    ...
    url = 'https://drive.google.com/u/0/uc?export=download&confirm=VJfU&id=1hbzc_P1FuxMkcabkgn9ZKinBwW683j45'
    ...
    def _download(self):
        ...
        download_url(self.url, self.root, self.filename, md5=self.tgz_md5)
