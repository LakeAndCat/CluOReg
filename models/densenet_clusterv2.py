...
------------      -----------    --------    -----------
2020/7/9 16:15   guzhouweihu      1.0         None
'''
...
__all__ = ['DenseNet', 'densenetd40k12', 'densenetd40k40', 'densenetd100k12', 'densenetd100k40', 'densenetd190k12']
...
class DenseNet(nn.Module):
    ...
    def __init__(self, growth_rate=12, block_config=[16, 16, 16], compression=0.5, n_cluster=100, cluster_m=1.3,
        ...
        # cluster
        self.cluster_layer = ClusterLayer(n_cluster, num_features, cluster_m)
    ...
    def forward(self, x):
        ...
        if self.KD == True:
            ...
            return x, x_f, cTok_output


def densenetd40k12(pretrained=False, path=None, **kwargs):
    """
    Constructs a densenetD40K12 models.
...
def densenetd100k12(pretrained=False, path=None, **kwargs):
    """
    Constructs a densenetD100K12 models.
...
def densenetd190k12(pretrained=False, path=None, **kwargs):
    """
    Constructs a densenetD190K12 models.
...
def densenetd100k40(pretrained=False, path=None, **kwargs):
    """
    Constructs a densenetD100K40 models.
...
def densenetd40k40(pretrained=False, path=None, **kwargs):
    """
    Constructs a densenetD40K12 models.
    ...
    model = DenseNet(growth_rate=40, block_config=[6, 6, 6], **kwargs)
    if pretrained:
        model.load_state_dict((torch.load(path))['state_dict'])
    return model