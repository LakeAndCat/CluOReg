...
------------      -----------    --------    -----------
2020/10/23 20:10   guzhouweihu      1.0         None
'''
...
class DenseNet(nn.Module):
    ...
    def __init__(self, growth_rate=32, block_config=(6, 12, 24, 16),
        ...
        # Linear layer
        self.classifier = nn.Linear(num_features, num_classes, bias=bias)
...
def densenet121(pretrained=False, progress=True, num_classes=10, bias=True, **kwargs):
